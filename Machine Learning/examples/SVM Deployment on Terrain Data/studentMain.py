...
accuracy = accuracy_score(pred, labels_test)
prettyPicture(clf_linear, features_test, labels_test)
print (' accuracy linear kernel and big gamma: ', accuracy)
...
print (' accuracy rbf kernel and big gamma: ', accuracy)
...
print (' accuracy rbf kernel and big gamma, big C: ', accuracy)
...
print (' accuracy rbf kernel and big C: ', accuracy)