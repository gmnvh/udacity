...
class VehicleMovePlot(object):
    ...
    def __init__(self, points=None):        
        self.fig = plt.figure()
        self.ax = self.fig.add_subplot(111, xlim=(-10, 50), ylim=(-10, 50))
        self.ax.grid(True)
...
def receive():
    global myplot, points
    
    time.sleep(5)
    myplot.update(points)
...
for i in range(180):
    ...
    points.append([last_x, last_y, angle])

myplot = VehicleMovePlot(points)
