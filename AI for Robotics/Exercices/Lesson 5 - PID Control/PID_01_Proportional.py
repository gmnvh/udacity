...
x_trajectory, y_trajectory, ster_ang = run(robot, 0.1)
n = len(x_trajectory)

# Print values for tau = 0.1
...
# Run with tau 0.3
robot.set(0.0, 1.0, 0.0)
x_trajectory, y_trajectory, ster_ang = run(robot, 0.3)
n = len(x_trajectory)

# Add to graph
ax2.plot(x_trajectory, y_trajectory, 'g', label='P controller')
