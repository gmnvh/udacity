...
x_trajectory, y_trajectory, ster_ang = run(robot, 0.1, 3.0)
n = len(x_trajectory)
...
robot.set(0.0, 1.0, 0.0)
x_trajectory, y_trajectory, ster_ang = run(robot, 0.3, 3.0)
n = len(x_trajectory)
...
robot.set(0.0, 1.0, 0.0)
x_trajectory, y_trajectory, ster_ang = run(robot, 0.1, 6.0)
n = len(x_trajectory)
...
robot.set(0.0, 1.0, 0.0)
x_trajectory, y_trajectory, ster_ang = run(robot, 0.3, 6.0)
n = len(x_trajectory)
